...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="registyles.css">
  </head>
  <body>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="LastName" id="LastName" placeholder="SurName" required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="MiddleName" id="MiddleName" placeholder="Middle Initial" required>
                    </div>
                </div>
            </div>
